...
#ifndef GAME_SERVER_ENTITIES_PROJECTILE_CCONTROLLER_H
#define GAME_SERVER_ENTITIES_PROJECTILE_CCONTROLLER_H
...
#endif //GAME_SERVER_ENTITIES_PROJECTILE_CCONTROLLER_H