...
void CBMortar::Animate()
{
	...
	if (gpGlobals->time > pev->dmgtime)
	{
		...
		MortarSpray(pev->origin, -pev->velocity.Normalize(), 3);
	}
...
void CBMortar::Touch(CBaseEntity* pOther)
{
	...
	// make some flecks
	MortarSpray(tr.vecEndPos, tr.vecPlaneNormal, 24);
...
void CBMortar::MortarSpray(const Vector& position, const Vector& direction, int count) const
{
