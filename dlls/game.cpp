...
cvar_t timeddamage = {"timed_damage", "0", FCVAR_SERVER | FCVAR_ARCHIVE};
//AJH Time based damage (nervegas/rad, not poison) on/off
cvar_t maxcameras = {"max_cameras", "2", FCVAR_SERVER | FCVAR_ARCHIVE};
//AJH the maximum number of inventory cameras a player may carry
cvar_t maxmedkit = {"max_medkit", "200", FCVAR_SERVER | FCVAR_ARCHIVE};
//AJH The maximum portable medkit charge a player may have
