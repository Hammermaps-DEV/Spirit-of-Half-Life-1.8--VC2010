...
int CController::LookupFloat()
{
	...
	if (Vfabs(x) > Vfabs(y) && Vfabs(x) > Vfabs(z))
	{
		if (x > 0)
...
void CControllerHeadBall::HuntThink(void)
{
	...
	if (gpGlobals->time - pev->dmgtime > 5 || pev->renderamt < 64 || m_hEnemy == NULL || m_hOwner == NULL || pev
	                                                                                                         ->origin.x
		< -4096 || pev->origin.x > 4096 || pev->origin.y < -4096 || pev->origin.y > 4096 || pev->origin.z < -4096 || pev
		                                                                                                             ->
		                                                                                                             origin
		                                                                                                             .z
		> 4096)
