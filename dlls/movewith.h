...
extern void UTIL_AssignOrigin(CBaseEntity* pEntity, Vector vecOrigin);
extern void UTIL_AssignOrigin(CBaseEntity* pEntity, Vector vecOrigin, BOOL bInitiator);
extern void UTIL_SetVelocity(CBaseEntity* pEnt, Vector vecSet);
extern void UTIL_AssignAngles(CBaseEntity* pEntity, Vector vecAngles);
extern void UTIL_AssignAngles(CBaseEntity* pEntity, Vector vecAngles, BOOL bInitiator);
extern void UTIL_SetAvelocity(CBaseEntity* pEnt, Vector vecSet);
extern void UTIL_SetMoveWithVelocity(CBaseEntity* pEnt, Vector vecSet, int loopbreaker);
extern void UTIL_SetMoveWithAvelocity(CBaseEntity* pEnt, Vector vecSet, int loopbreaker);
